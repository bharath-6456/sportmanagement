...
public class recordtable extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "equipid", "equipname", "studetname", "Rollno", "Date"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Connection con= connection.getCon();
           java.sql.Statement s;
            ...
            try (ResultSet rs = s.executeQuery("select * from records")) {
                while(rs.next()){
                    int eid=rs.getInt("equipid");
                    String name=rs.getString("name");
                    String stu=rs.getString("stuname");
                    String d=rs.getString("date");
                    String roll=rs.getString("rollno");
                    mdl.addRow(new Object[]{eid,name,stu,roll,d});
